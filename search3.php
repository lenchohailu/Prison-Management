        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-left">
                    <li class="active"><a href="index4.php"><i class="fa fa-fw fa-home"></i>Home</a></li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-fw fa-question"></i>Request<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="view_request3.php"><i class="fa fa-fw fa-check"></i>Approve</a></li>
                            <li><a href="approved.php"><i class="fa fa-fw fa-eye"></i>View Approved</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
        ...
        if (isset($_POST['search'])) {
            ...
            if (empty($searchP)) {
                ...
                if ($count == 0) {
                    ...
                    $stmt_paged->bind_param("ssssii", $likeSearch, $likeSearch, $likeSearch, $likeSearch, $endlimit, $start_from);
                    $stmt_paged->execute();
                ...
                ?>
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <form method="post" action="search3.php" class="form-horizontal">
                    ...
                    for ($i = 1; $i <= $total_pages; $i++) {
                        echo '<li><a href="search3.php?page=' . $i . '">' . $i . '</a></li>';
                    }
                    echo '</ul>';
                    $stmt->close();
                    $stmt_paged->close();
