...
<head>
    ...
    <meta name="description" content="Contact HU Prison Management System for inquiries, support, and information.">
    <meta name="author" content="HU Prison Management System">

    <title>Contact - HU Prison Management System</title>
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="profile.php"><i class="fa fa-fw fa-road"></i> Profile</a>
                            </li>
                            <li>
                                <a href="request.php"><i class="fa fa-fw fa-search"></i> Request</a>
                            </li>
                            <li>
                    ...
                    <li class="active">
                        <a href="contact.php"><i class="fa fa-fw fa-envelope-o"></i> Contact</a>
                    </li>
                </ul>
            ...
            <div class="col-md-8">
                <div class="map-container">
                    ...
                    <iframe width="100%" height="400px" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" 
                        ...
                        title="HU Prison Management System Location">
                    </iframe>
                </div>
            </div>
